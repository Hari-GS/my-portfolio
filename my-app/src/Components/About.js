...
function about() {
    return (
        <div className="about-text">
            <h4>Hello! I’m Hariharan G. I can to do Fullstack Web Development</h4>
            ...
            <h4>To know more about me, see my <a href="https://drive.google.com/file/d/1C2XEGUa1Kz1ZIxNJZD8wOYz8AT_o2ugF/view?usp=drive_link" className="resume-link" target="_blank">Resume</a></h4>
        </div>
    )
}
