...
function about() {
    return (
        <div className="about-text">
            ...
            <h4>To know more about me, see my <a href="https://drive.google.com/file/d/1i9D0wFTJcB-lTsLdeOPIY-qwW6KF3Fji/view?usp=sharing" className="resume-link" target="_blank">Resume</a></h4>
        </div>
    )
}
